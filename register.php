...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        // Check if email already exists using your existing function
        $existingUser = getUserByEmail($email);
        if ($existingUser) {
            $error = "Email already registered!";
        } else {
            // Register the user using your existing function
            ...
            if ($result === true) {
                ...
                $error = $result; // This will be the error message from registerUser
            }
        }
    }
}
...
<head>
    ...
    <title><?php echo getSiteName(); ?> - Register</title>
    ...
    <style>
        ...
        * {
        ...
        .auth-body > *:nth-child(3) { animation-delay: 0.2s; }
        .auth-body > *:nth-child(4) { animation-delay: 0.3s; }
        .auth-body > *:nth-child(5) { animation-delay: 0.4s; }
        .auth-body > *:nth-child(6) { animation-delay: 0.5s; }
        .auth-body > *:nth-child(7) { animation-delay: 0.6s; }
    </style>
</head>
    ...
    <div class="auth-container">
        ...
        <div class="auth-body">
            ...
            <div class="auth-links">
                <p>Already have an account? <a href="login.php" class="fw-bold">Sign in here</a></p>
            </div>
        </div>
    </div>
